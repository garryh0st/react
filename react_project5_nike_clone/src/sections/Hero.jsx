...
//           </h1>
//           <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish nike arrivals and quality comforts</p>
//           <Button
//            label="Shop Now"
//            iconURL={arrowRight}
//            />
...
//         width={600}
//         height={700}
//         className="object-cointain relative z-10"
//         />
//       <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:l-[10%] max-sm:px-6">
//       {shoes.map((shoe) => (
//         <div key={shoe}>
//         <ShoeCard
//         imgURL= {shoe}
